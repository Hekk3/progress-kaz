...
return [
    ...
    */
    ...
    'active_url'      => ':attribute өрісінде URL жарамсыз.',
    'after'           => ':attribute өрісінде келесі күн болуы керек :date.',
    'after_or_equal'  => ':attribute күнінен кейін немесе оған тең күн болуы керек.',
    'alpha'           => ':attribute өрісінде тек әріптер болуы керек.',
    'alpha_dash'      => ':attribute өрісінде тек әріптер, сандар, сызықшалар және астынғы сызықтар болуы мүмкін.',
    'alpha_num'       => ':attribute өрісінде тек әріптер мен сандар болуы керек.',
    'array'           => ':attribute өрісі массив болуы керек.',
    'before'          => ':attribute өрісінде күн бұрын болуы керек :date.',
    'before_or_equal' => ':attribute өрісі күн немесе оған тең күн болуы керек. :date.',
    'between'         => [
    ...
    'filled'         => ':attribute өрісі міндетті турде толтырылуы керек.',
    'gt'             => [
    ...
    'required'             => ':attribute өрісі міндетті турде толтырылуы керек.',
    ...
    */
    ...
    'attributes' => [
        ...
        'size'                  => 'Размер',
        'message'               => '«Хабарлама»',
        'phone_email'           => '«Телефон нөмірі / e-mail»',
    ],
];
