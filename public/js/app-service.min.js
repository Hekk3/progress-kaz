/*! jQuery v3.5.1 | (c) JS Foundation and other contributors | jquery.org/license */ !(function(
                ...
                if (11 !== w && (u = J.exec(e)))
                    if ((s = u[1])) {
                        ...
                        if (
                            ...
                            return H.apply(o, t.getElementsByClassName(s)), o;
                    }
                if (
                    n.qsa &&
                    !A[e + " "] &&
                                    ...
                                    if (void 0 !== t.getElementById && g) {
                                        ...
                                        if (s) {
                                            if ((n = s.getAttributeNode("id")) && n.value === e)
                                                return [s];
                                            for (i = t.getElementsByName(e), o = 0;
                                                (s = i[o++]);)
                                                if ((n = s.getAttributeNode("id")) && n.value === e)
                                                    return [s];
                                        }
            ...
            return (
                ...
                ce(function(s, r, a, l) {
                    var c,
                        ...
                        m = n ? (i || (s ? e : h || o) ? [] : r) : v;
                    if ((n && n(v, m, a, l), o))
                        for (c = Te(m, f), o(c, [], a, l), d = c.length; d--;)
                            (u = c[d]) && (m[f[d]] = !(v[f[d]] = u));
                    if (s) {
                        if (i || e) {
                            if (i) {
        ...
        return (
                        ...
                        ((i = h),
                            ...
                            (d = function(e, t, n, r, d) {
                                var u,
                                    ...
                                    k = S.length;
                                for (
                                    d && (c = t == f || t || d); y !== k && null != (u = S[y]); y++
                                ) {
                                    if (l && u) {
                                        for (
                                            h = 0, t || u.ownerDocument == f || (p(u), (n = !g));
                                            (v = i[h++]);
            ...
            (l = ae.select = function(e, t, n, i) {
                ...
                if (((n = n || []), 1 === f.length)) {
                    ...
                    for (
                        s = V.needsContext.test(e) ? 0 : l.length; s-- && ((c = l[s]), !o.relative[(d = c.type)]);
                        ...
                        if (
                            ...
                            if ((l.splice(s, 1), !(e = i.length && be(l))))
    ...
    w.fn.extend({
        ...
        is: function(e) {
            return !!E(this, "string" == typeof e && $.test(e) ? w(e) : e || [], !1)
                .length;
        },
    });
    var L,
            ...
            if (o[1]) {
                if (
                    ((t = t instanceof w ? t[0] : t),
                        w.merge(
                            this,
                            w.parseHTML(o[1], t && t.nodeType ? t.ownerDocument || t : v, !0)
                        ),
        ...
        w.each({
            ...
            function(e, t) {
                w.fn[e] = function(n, o) {
                    ...
                    return (
                        "Until" !== e.slice(-5) && (o = n),
                        o && "string" == typeof o && (i = w.filter(o, i)),
                        1 < this.length &&
                        (H[e] || w.uniqueSort(i), j.test(e) && i.reverse()),
                        this.pushStack(i)
                    );
                };
            }
            ...
            var n = [
                ...
                i = {
                    ...
                    then: function(t, o, i) {
                        ...
                        return w
                            .Deferred(function(e) {
                                n[0][3].add(r(0, e, h(i) ? i : I, e.notifyWith)),
                                    n[1][3].add(r(0, e, h(t) ? t : I)),
                                    n[2][3].add(r(0, e, h(o) ? o : q));
                            })
                            .promise();
                    },
                    promise: function(e) {
        ...
        when: function(e) {
            var t = arguments.length,
                ...
                a = function(e) {
                    return function(n) {
                        (o[e] = this),
                        (s[e] = 1 < arguments.length ? i.call(arguments) : n),
                        --t || r.resolveWith(o, s);
                    };
                };
            if (
                t <= 1 &&
                (N(e, r.done(a(n)).resolve, r.reject, !t),
        ...
        w.fn.extend({
            data: function(e, t) {
                ...
                if (void 0 === e) {
                    if (
                        this.length &&
                        ((i = Q.get(s)), 1 === s.nodeType && !G.get(s, "hasDataAttrs"))
                    ) {
                        for (n = r.length; n--;)
                            r[n] &&
    ...
    function be(e, t, n, o, i) {
        ...
        for (u.textContent = "", f = 0;
            ...
            ((c = ie(s)), (r = ve(u.appendChild(s), "script")), c && me(r), n)
        )
            for (d = 0;
                (s = r[d++]);) he.test(s.type || "") && n.push(s);
        return u;
    }
    var xe = /^key/,
                        ...
                        if (1 & e.isTrigger && this[t]) {
                            if (r.length)
                                ...
                                ((r = i.call(arguments)),
                                    ...
                                    (o = n(this, t)),
                                    this[t](),
                                    r !== (s = G.get(this, t)) || o ? G.set(this, t, !1) : (s = {}),
                                    r !== s)
                            )
                                return (
        ...
        special: {
            ...
            click: {
                setup: function(e) {
                    var t = this || e;
                    return (
                        pe.test(t.type) && t.click && A(t, "input") && Ae(t, "click", Se), !1
                    );
                },
                trigger: function(e) {
                    var t = this || e;
    ...
    w.each({
        ...
        w.fn.extend({
            ...
            off: function(e, t, n) {
                ...
                return (
                    (!1 !== t && "function" != typeof t) || ((n = t), (t = void 0)), !1 === n && (n = Ce),
                    this.each(function() {
    ...
    function Oe(e, t, n, o) {
        ...
        if (
            p &&
            ((r = (i = be(t, e[0].ownerDocument, !1, e, o)).firstChild),
                1 === i.childNodes.length && (i = r),
                r || o)
        ) {
            for (l = (a = w.map(ve(i, "script"), je)).length; u < p; u++)
                (c = i),
                u !== g &&
            ...
            if (l)
                for (d = a[a.length - 1].ownerDocument, w.map(a, He), u = 0; u < l; u++)
                    ...
                    (c.src && "module" !== (c.type || "").toLowerCase() ?
                        ...
                        y(c.textContent.replace(Le, ""), c, d));
        }
        return e;
    }

    function Ie(e, t, n) {
        for (var o, i = t ? w.filter(t, e) : e, s = 0; null != (o = i[s]); s++)
            n || 1 !== o.nodeType || w.cleanData(ve(o)),
            o.parentNode &&
            (n && ie(o) && me(ve(o, "script")), o.parentNode.removeChild(o));
        return e;
    }
    w.extend({
            ...
            clone: function(e, t, n) {
                ...
                if (t)
                    if (n)
                        for (s = s || ve(e), r = r || ve(d), o = 0, i = s.length; o < i; o++)
                            Me(s[o], r[o]);
                    else Me(e, d);
                return (
                ...
                for (var t, n, o, i = w.event.special, s = 0; void 0 !== (n = e[s]); s++)
                    if (U(n)) {
                        if ((t = n[G.expando])) {
                            if (t.events)
                                for (o in t.events)
                                    i[o] ? w.event.remove(n, o) : w.removeEvent(n, o, t.handle);
                            n[G.expando] = void 0;
                        }
        ...
        w.each({
            ...
            function(e, t) {
                w.fn[e] = function(e) {
                    for (var n, o = [], i = w(e), s = i.length - 1, a = 0; a <= s; a++)
    ...
    function Re(e, t, n) {
        ...
        return (
            ...
            ("" !== (r = n.getPropertyValue(t) || n[t]) ||
                ie(e) ||
                (r = w.style(e, t)), !f.pixelBoxStyles() &&
                qe.test(r) &&
                Fe.test(t) &&
                ((o = a.width),
                    (i = a.minWidth),
        ...
        return (
            ...
            (e in _e ?
                ...
                (Xe[e] =
                    (function(e) {
                        for (
                            var t = e[0].toUpperCase() + e.slice(1), n = Be.length; n--;
    ...
    function Ke(e, t, n, o, i, s) {
        ...
        for (; r < 4; r += 2)
            ...
            o ?
            ("content" === n && (l -= w.css(e, "padding" + ne[r], !0, i)),
                "margin" !== n &&
                (l -= w.css(e, "border" + ne[r] + "Width", !0, i))) :
            ((l += w.css(e, "padding" + ne[r], !0, i)),
                "padding" !== n ?
                (l += w.css(e, "border" + ne[r] + "Width", !0, i)) :
                (a += w.css(e, "border" + ne[r] + "Width", !0, i)));
        return (!o &&
            0 <= s &&
            (l +=
                Math.max(
    ...
    function Je(e, t, n) {
        ...
        return (
            ((!f.boxSizingReliable() && i) ||
                ...
                "auto" === r ||
                (!parseFloat(r) && "inline" === w.css(e, "display", !1, o))) &&
            e.getClientRects().length &&
            ((i = "border-box" === w.css(e, "boxSizing", !1, o)),
                (s = a in e) && (r = e[a])),
            (r = parseFloat(r) || 0) +
            Ke(e, t, n || (i ? "border" : "content"), s, o, r) +
            "px"
        );
    }
            ...
            style: function(e, t, n, o) {
                if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                    var i,
                        ...
                        c = e.style;
                    if (
                        (l || (t = Ye(a)), (r = w.cssHooks[t] || w.cssHooks[a]), void 0 === n)
                    )
        ...
        w.each({
            ...
            function(e, t) {
                (w.cssHooks[e + t] = {
                    expand: function(n) {
                        for (
                            var o = 0, i = {}, s = "string" == typeof n ? n.split(" ") : [n]; o < 4; o++
                        )
                            i[e + ne[o] + t] = s[o] || s[o - 2] || s[0];
                        return i;
                    },
                }),
                ...
                return W(
                    ...
                    function(e, t, n) {
                        var o,
                            ...
                            r = 0;
                        if (Array.isArray(t)) {
                            for (o = Ne(e), i = t.length; r < i; r++)
                                s[t[r]] = w.css(e, t[r], !1, o);
                            return s;
                        }
    ...
    function ut(e, t, n) {
        ...
        for (
            ...
            if ((o = ut.prefilters[s].call(c, e, d, c.opts)))
                return (
                    h(o.stop) &&
                    (w._queueHooks(c.elem, c.opts.queue).stop = o.stop.bind(o)),
                    o
                );
        return (
            w.map(d, dt, c),
                ...
                if ((l = !w.isEmptyObject(t)) || !w.isEmptyObject(f))
                    for (o in (u &&
                        ...
                        (v ?
                            ...
                            g && ce([e], !0),
                            p.done(function() {
                                for (o in (g || ce([e]), G.remove(e, "fxshow"), f))
                                    w.style(e, o, f[o]);
                            })),
                        (l = dt(g ? v[o] : 0, o, p)),
                        o in v ||
                ...
                return (
                    ...
                    this.each(function() {
                        ...
                        if (i) r[i] && r[i].stop && o(r[i]);
                            ...
                            for (i in r) r[i] && r[i].stop && rt.test(i) && o(r[i]);
                        for (i = s.length; i--;)
                            s[i].elem !== this ||
                            (null != e && s[i].queue !== e) ||
        ...
        w.extend({
            valHooks: {
                ...
                select: {
                    ...
                    set: function(e, t) {
                        for (
                            var n, o, i = e.options, s = w.makeArray(t), r = i.length; r--;

                        )
                            ((o = i[r]).selected = -1 < w.inArray(w.valHooks.option.get(o), s)) && (n = !0);
    ...
    w.extend(w.event, {
            trigger: function(t, n, o, i) {
                ...
                if (
                    ...
                    if (!i && !p.noBubble && !g(o)) {
                        for (
                            l = p.delegateType || y, xt.test(l + y) || (r = r.parentNode); r; r = r.parentNode
                        )
                            m.push(r), (a = r);
                        a === (o.ownerDocument || v) &&
                    ...
                    for (s = 0;
                        ...
                        (u =
                            (G.get(r, "events") || Object.create(null))[t.type] &&
                            G.get(r, "handle")) && u.apply(r, n),
                        (u = c && r[c]) &&
                        u.apply &&
                        U(r) &&
            ...
            ajax: function(t, n) {
                ...
                for (u in ((d = w.event && f.global) &&
                        ...
                        ((p = f.url.slice(i.length)),
                            ...
                            ((i += (Ct.test(i) ? "&" : "?") + f.data), delete f.data), !1 === f.cache &&
                            ((i = i.replace(jt, "$1")),
                ...
                if (
                    ...
                    if (((C.readyState = 1), d && g.trigger("ajaxSend", [C, f]), c))
                        return C;
                    f.async &&
                        0 < f.timeout &&
                    ...
                    c ||
                        ((c = !0),
                            ...
                            (x = (function(e, t, n, o) {
                                ...
                                for (s = d.shift(); s;)
                                    if (
                                        (e.responseFields[s] && (n[e.responseFields[s]] = t), !l && o && e.dataFilter && (t = e.dataFilter(t, e.dataType)),
                                            (l = s),
                                            (s = d.shift()))
                                    )
                                        if ("*" === s) s = l;
                            ...
                            (f.ifModified &&
                                ((T = C.getResponseHeader("Last-Modified")) &&
                                    (w.lastModified[i] = T),
                                    (T = C.getResponseHeader("etag")) && (w.etag[i] = T)),
                                204 === t || "HEAD" === f.type ?
                                (S = "nocontent") :
                                304 === t ?
                                (S = "notmodified") :
                            ...
                            (C.status = t),
                            (C.statusText = (n || S) + ""),
                            u ? m.resolveWith(h, [p, S, C]) : m.rejectWith(h, [C, S, v]),
                            C.statusCode(b),
                            (b = void 0),
                            d && g.trigger(u ? "ajaxSuccess" : "ajaxError", [C, f, u ? p : v]),
                            y.fireWith(h, [C, S]),
                            d &&
    ...
    w.ajaxSetup({
        ...
        w.ajaxPrefilter("json jsonp", function(t, n, o) {
            ...
            if (a || "jsonp" === t.dataTypes[0])
                return (
                    ...
                    o.always(function() {
                        void 0 === s ? w(e).removeProp(i) : (e[i] = s),
        ...
        (f.createHTMLDocument =
            (((Xt = v.implementation.createHTMLDocument("").body).innerHTML =
                    "<form></form><form></form>"),
        ...
        (w.parseHTML = function(e, t, n) {
            return "string" != typeof e ?
                ...
                ("boolean" == typeof t && ((n = t), (t = !1)),
                    t ||
                    (f.createHTMLDocument ?
                        (((o = (t = v.implementation.createHTMLDocument(
                                ""
        ...
        (w.fn.load = function(e, t, n) {
            var o,
                ...
                r = this,
                a = e.indexOf(" ");
            return (-1 < a && ((o = vt(e.slice(a))), (e = e.slice(0, a))),
                h(t) ?
                ((n = t), (t = void 0)) :
                ...
                if (this[0]) {
                    ...
                    if ("fixed" === w.css(o, "position")) t = o.getBoundingClientRect();
                        ...
                        for (
                            t = this.offset(),
                            n = o.ownerDocument,
                            e = o.offsetParent || n.documentElement; e &&
        ...
        w.each(["top", "left"], function(e, t) {
            w.cssHooks[t] = We(f.pixelPosition, function(e, n) {
                if (n)
                    return (n = Re(e, t)), qe.test(n) ? w(e).position()[t] + "px" : n;
            });
        }),
        w.each({
                Height: "height",
...
(function(e) {
        ...
        i.animateHeight(), !0 === i.options.rtl && !1 === i.options.vertical && (t = -t), !1 === i.transformsEnabled ?
            ...
            (!0 === i.options.rtl && (i.currentLeft = -i.currentLeft),
                e({
                    ...
                    step: function(e) {
                        (e = Math.ceil(e)), !1 === i.options.vertical ?
            ...
            (i.applyTransition(),
                (t = Math.ceil(t)), !1 === i.options.vertical ?
    ...
    (t.prototype.applyTransition = function(e) {
        ...
        !1 === t.options.fade ?
            (n[t.transitionType] =
                ...
                t.options.cssEase) :
            (n[t.transitionType] =
                "opacity " + t.options.speed + "ms " + t.options.cssEase), !1 === t.options.fade ? t.$slideTrack.css(n) : t.$slides.eq(e).css(n);
    }),
    ...
    (t.prototype.getLeft = function(e) {
        ...
        return (
            (s.slideOffset = 0),
            (n = s.$slides.first().outerHeight(!0)), !0 === s.options.infinite ?
            (s.slideCount > s.options.slidesToShow &&
                ((s.slideOffset = s.slideWidth * s.options.slidesToShow * -1),
                    (i = -1), !0 === s.options.vertical &&
            ...
            s.slideCount <= s.options.slidesToShow &&
            ((s.slideOffset = 0), (r = 0)), !0 === s.options.centerMode && s.slideCount <= s.options.slidesToShow ?
            (s.slideOffset =
            ...
            ((s.slideOffset = 0),
                (s.slideOffset +=
                    s.slideWidth * Math.floor(s.options.slidesToShow / 2))),
            (t = !1 === s.options.vertical ?
                e * s.slideWidth * -1 + s.slideOffset :
                e * n * -1 + r), !0 === s.options.variableWidth &&
            ((o =
                    s.slideCount <= s.options.slidesToShow ||
    ...
    (t.prototype.initializeEvents = function() {
        ...
        t.initArrowEvents(),
            ...
            e(document).on(t.visibilityChange, e.proxy(t.visibility, t)), !0 === t.options.accessibility &&
        ...
        if (
            (!0 === s.options.centerMode ?
                ...
                ((o = s.options.infinite ?
                        ...
                        s.currentSlide),
                    (i = Math.ceil(o + s.options.slidesToShow)), !0 === s.options.fade &&
                    (o > 0 && o--, i <= s.slideCount && i++)),
                (n = s.$slider.find(".slick-slide").slice(o, i)),
                "anticipated" === s.options.lazyLoad)
        )
            for (
                var r = o - 1, a = i, l = s.$slider.find(".slick-slide"), c = 0; c < s.options.slidesToScroll; c++
            )
    ...
    (t.prototype.refresh = function(t) {
        var n,
            o,
            i = this;
        (o = i.slideCount - i.options.slidesToShow), !i.options.infinite && i.currentSlide > o && (i.currentSlide = o),
    ...
    (t.prototype.setCSS = function(e) {
        ...
        !0 === o.options.rtl && (e = -e),
            ...
            (i[o.positionProp] = e), !1 === o.transformsEnabled ?
            o.$slideTrack.css(i) :
            ((i = {}), !1 === o.cssTransitions ?
    ...
    (t.prototype.setFade = function() {
        ...
        n.$slides.each(function(o, i) {
                (t = n.slideWidth * o * -1), !0 === n.options.rtl ?
                    e(i).css({
                        position: "relative",
                        right: t,
                        top: 0,
    ...
    (t.prototype.setSlideClasses = function(e) {
        ...
        if (
            ...
            (t = Math.floor(s.options.slidesToShow / 2)), !0 === s.options.infinite &&
    ...
    (t.prototype.setupInfinite = function() {
        var t,
            ...
            i = this;
        if (
            (!0 === i.options.fade && (i.options.centerMode = !1), !0 === i.options.infinite &&
                !1 === i.options.fade &&
                ((n = null), i.slideCount > i.options.slidesToShow))
        ) {
            for (
                o = !0 === i.options.centerMode ?
        ...
        if (!(!1 === t.options.swipe ||
            ...
            switch (
                ((t.touchObject.fingerCount =
                        ...
                        1),
                    (t.touchObject.minSwipe = t.listWidth / t.options.touchThreshold), !0 === t.options.verticalSwiping &&
    ...
    (t.prototype.swipeMove = function(e) {
        var t,
            ...
            a = this;
        return (
            (s = void 0 !== e.originalEvent ? e.originalEvent.touches : null), !(!a.dragging || a.scrolling || (s && 1 !== s.length)) &&
            ((t = a.getLeft(a.currentSlide)),
                ...
                (!0 === a.options.verticalSwiping &&
                    ...
                    (a.swipeLeft = t + o * i) :
                    (a.swipeLeft =
                        t + o * (a.$list.height() / a.listWidth) * i), !0 === a.options.verticalSwiping && (a.swipeLeft = t + o * i), !0 !== a.options.fade &&
        ...
        n.extend(g.prototype, {
                ...
                jumpTo: function(e, t) {
                    ...
                    if (!(f.isDragging || f.isClosing || (f.isAnimating && f.firstRun))) {
                        if (
                            ((e = parseInt(e, 10)), !(s = f.current ? f.current.opts.loop : f.opts.loop) &&
                                (e < 0 || e >= h))
                        )
                            return !1;
                        if (
                ...
                createSlide: function(e) {
                    var t,
                        ...
                        i = this;
                    return (
                        (o = (o = e % i.group.length) < 0 ? i.group.length + o : o), !i.slides[e] &&
                        i.group[o] &&
                ...
                isMoved: function(e) {
                    ...
                    return (!!i &&
                        ((o = n.fancybox.getTranslate(this.$refs.stage)),
                            (t = n.fancybox.getTranslate(i.$slide)), !i.$slide.hasClass("fancybox-animated") &&
                ...
                afterLoad: function(e) {
                    ...
                    t.isClosing ||
                        ((e.isLoading = !1),
                            ...
                            t.hideLoading(e), !e.opts.smallBtn ||
                ...
                focus: function(e, o) {
                    ...
                    r.isClosing ||
                        ((i = (i = !e && r.current && r.current.isComplete ?
                ...
                close: function(e, t) {
                    ...
                    return !(
                        u.isClosing ||
                        ((u.isClosing = !0), !1 === u.trigger("beforeClose", e) ?
                            ((u.isClosing = !1),
                                c(function() {
                                    u.update();
                                }),
                ...
                trigger: function(e, t) {
                    ...
                    if (
                        (r ? i.unshift(r) : (r = s),
                            i.unshift(s),
                            n.isFunction(r.opts[e]) && (o = r.opts[e].apply(r, i)), !1 === o)
                    )
                        return o;
                    "afterClose" !== e && s.$refs ?
                ...
                showControls: function() {
                    ...
                    n
                        ...
                        .toggleClass(
                            "fancybox-show-infobar", !!(t.infobar && e.group.length > 1)
                        )
                        .toggleClass("fancybox-show-caption", !!e.$caption)
                        .toggleClass(
                            "fancybox-show-nav", !!(t.arrows && e.group.length > 1)
                        )
...
(function(e, t, n) {
    ...
    (d.prototype.endSwiping = function(e, t) {
        ...
        "y" == e && !t && Math.abs(o.distanceY) > 50 ?
            ...
            a && o.distanceX < 0 && (i = o.instance.next(300)), !1 !== i || ("x" != e && "y" != e) || o.instance.centerSlide(200),
...
(function(e, t) {
    ...
    t.extend(o.prototype, {
            ...
            init: function(e) {
                ...
                for (
                    var i = 0, s = n.length; i < s && (n[i].thumb && o++, !(o > 1)); i++
                );
                o > 1 && t.opts ?
...
$(document).ready(function() {
    ...
    $(
            ".main-slider .main-slider__item .main-slider__item-wrap .under-slide-wrap .under-slide"
        ).each(function() {
            $(this).attr("class", function(e) {
                    $(this).addClass("slide-cnt" + n),
                        $(".slide-cnt" + n).slick({
                            slidesToShow: 2,
                            arrows: true,
                            centerMode: true,
                ...
                $(`.slide-cnt${n} .under-slide__item-img a`)
                .fancybox({
                    animationEffect: "fade",
                })
                .attr("data-fancybox", "gallery1" + n),
                n++;
        }),
        $(".catalog-dropdown").hover(function() {
            $(this).toggleClass("active"), $(".catalog-btn").toggleClass("active");
        }),
        $(".tab_item")
        .not(":first")
        .hide(),
        $(".download-info-tabs-wrapper .tab")
        .click(function() {
            $(".download-info-tabs-wrapper .tab")
                .removeClass("active")
                .eq($(this).index())
        ...
        $(".slick-center")
        .next()
        .addClass("after-center"),
        $(".slick-next").click(function() {
            $(".slick-center").removeClass("after-center"),
                $(".slick-center")
                .prev()
                .addClass("before-center"),
                $(".slick-center")
                .next()
                .addClass("after-center");
        }),
    ...
    if (document.getElementById("map")) {
        DG.then(function() {
            ...
            DG.marker([43.237734, 76.932223]).addTo(t);
        });
    }
    $(".main-slider-prev").click(() => {
        document.querySelector(".main-slider .slick-arrow.slick-prev").click();
    });
    $(".main-slider-next").click(() => {
        document.querySelector(".main-slider .slick-arrow.slick-next").click();
    });
});
